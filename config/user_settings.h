...
/* Enable DILITHIUM signature scheme */
#define HAVE_DILITHIUM
#define WOLFSSL_WC_DILITHIUM

/* Enable SHA3, SHAKE128 and SHAKE256 (required for dilithium) */
#define WOLFSSL_SHA3
#define WOLFSSL_SHAKE256
#define WOLFSSL_SHAKE128

// Define the USE_CRYPTO macro (or it can be defined externally via compiler flags)
#define USE_CRYPTO

// /* Use PDL CRYPTO RNG block */
// extern int Cy_Crypto_Gen_RNG_Block(unsigned char* output, unsigned int sz);
// #define CUSTOM_RAND_GENERATE_BLOCK Cy_Crypto_Gen_RNG_Block
